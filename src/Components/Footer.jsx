...
import portlogo from '../assets/WhatsApp_Image_2024-07-07_at_11.05.45_e531af7c-ai-brush-removebg-ck07nl9t.png'
...
<footer
  ...
  <div className='h-[7vh] flex justify-center items-center'>
    ...
    <div class="mb-6 flex justify-center space-x-2">
      <a
        href="https://www.instagram.com/sk__jeelani/"
      ...
      <a
        href="https://mail.google.com/mail/?view=cm&fs=1&to=sjilani443@gmail.com&su=Subject%20Here&body=Body%20text%20here"
        type="button" target="_blank"
      ...
      <a
        href="https://www.linkedin.com/in/jeelani-shaik-82b79a23b/"
        type="button" target="_blank"
      ...
      <a
        href="https://github.com/sjilani443"
        type="button" target="_blank"
  ...
  <div class="w-full bg-black/5 p-4 text-center font-space">
